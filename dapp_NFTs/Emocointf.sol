...
contract ColeccionMisemogis is ERC721 {
    string private _nombre = "Misemogis"; // Nombre de la colección de NFTs
    string private _simbolo = "Emos"; // Símbolo de la colección de NFTs
    ...
    // Trasnferir de forma segura un token de una dirección a otra
    ...
    // Crea un nuevo token y lo asigna a una dirección
