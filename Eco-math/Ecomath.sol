...
contract EcoMath is IERC20 {
    string public constant name = "ECOMATH";
    string public constant symbol = "MATH";
    uint8 public constant decimals = 18;
    uint256 private _totalSupply = 100000 * 10 ** uint256(decimals); // 100.000 tokens con 18 decimales
